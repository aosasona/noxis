...
<img src="{{asset('/img/user.png')}}" class='p-6 w-2/3 lg:w-1/3 border-0 rounded-[50%]' alt='profile image'/>
<div class='text-sky-500 mt-2 text-lg'><h2 class='inline'>@</h2><h2 class='inline'>{{ $user[0]->username }}</h2></div>
