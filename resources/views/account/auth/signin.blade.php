...
@section('content')
    ...
    <div class="flex w-screen h-[85vh] justify-center items-center px-4">
        ...
        <form method="POST" action="/signin-auth" class="bg-zinc-800 px-7 py-6 pb-9 rounded-xl w-full lg:w-2/3">
            @csrf
            ...
            <div class="lg:px-5">
                ...
                <div class="flex flex-row justify-between items-center mt-10">
                    <a href="/signin" class="underline hover:text-sky-500">Go Back</a>
