...
@section('content')
    ...
    <div
        ...
        <span class="px-8"><a href="{{ route('chats') }}"><i
            ...
            @foreach ($chats as $chat)
                @if (strtolower($chat->from) === strtolower($currentUser))
                    <div class="flex w-full justify-end">
                        <!-- Sent by user -->
                        <div
                            class="bg-sky-700 text-white w-auto max-w-[75vw] xl:max-w-[55%] py-2 px-5 rounded-2xl font-medium break-words mb-4">
    ...
    <div id="confirm" class="fixed top-0 left-0 right-0 bottom-0">
        ...
        <div class="absolute top-0 left-0 right-0 bottom-0 w-screen h-screen bg-black opacity-60 z-[-1]" id="confirm__container"></div>
    </div>
@endsection
