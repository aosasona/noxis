...
<div class="w-full px-8 mt-4 lg:mt-0 lg:my-20 text-left lg:text-center font-light lg:font-medium text-lg lg:text-2xl text-white" data-aos="fade-up" data-aos-duration="1000" id="home__about"><span class="text-sky-600">RanCh</span> is a web service aimed at giving you a platform to communicate quickly, easily & anonymously with whomever you want to chat with –
...
<div class="w-full px-8 pb-5 lg:px-4 lg:mx-0 flex flex-col lg:flex-row text-center mt-10 lg:mt-32 lg:justify-around">
    <div class="w-full mt-6 lg:mt-0 lg:w-1/3 bg-zinc-800 p-4 rounded-xl lg:mx-4" data-aos="zoom-in" data-aos-duration="1000">
        <img src="{{ asset('img/chat.svg') }}" alt="Main SVG" class="h-3/4 p-4"/>
        <h1 class="text-2xl font-semibold ">Quick Setup</h1>
    </div>

    <div class="w-full mt-6 lg:mt-0 lg:w-1/3 bg-zinc-800 p-4 rounded-xl lg:mx-4" data-aos="zoom-in" data-aos-duration="1000">
        <img src="{{ asset('img/fast.svg') }}" alt="Main SVG" class="h-3/4 p-4"/>
        <h1 class="text-2xl font-semibold ">Text Anonymously</h1>
    </div>

    <div class="w-full mt-6 lg:mt-0 lg:w-1/3 bg-zinc-800 p-4 rounded-xl lg:mx-4" data-aos="zoom-in" data-aos-duration="1000">
        <img src="{{ asset('img/secure.svg') }}" alt="Main SVG" class="h-3/4 p-4"/>
