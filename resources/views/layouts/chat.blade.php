...
<div class="bg-zinc-800 fixed bottom-0 flex flex-row w-screen h-auto justify-evenly items-center py-6 m-0 text-xl text-white">
    ...
    <a href='/users/{{}}'><i class="fa-solid fa-user hover:text-sky-500"></i></a>
</div>
